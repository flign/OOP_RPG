...
namespace OOP_RPG
{
    public class Game
    {
        ...
        private void SaveGame()
        {
            ...
            FileDatabase.UpdateFile1(heroData);
            //string weaponData = Hero.GetWeapon();
            //FileDatabase.UpdateFile3(weaponData);
            string achievementsData = AchievementManager.GetAchievement();
            FileDatabase.UpdateFile2(achievementsData);
        }
    }
}
