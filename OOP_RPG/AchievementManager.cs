...
namespace OOP_RPG
{
    public class AchievementManager
    {
        ...
        {
            string achievementsData = string.Empty;

            foreach (Achievement achievement in Achievements)
            {
                achievementsData += string.Format($"{achievement.Name},{achievement.Point},{achievement.Date}\n");
            }
        ...
        /*public void LoadAchievements(string[] ach)
        {
            ...
            {
                string[] achData = eachAchievement.Split(',');
                var temp = new Achievement(achData[0], Convert.ToInt32(achData[1]), Convert.ToDateTime(achData[2]));
